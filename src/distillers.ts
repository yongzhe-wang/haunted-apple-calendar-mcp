...
export const BUILT_IN_DISTILLERS: Distiller[] = [
  ...
  },
  {
    ...
    attribution: SYNTHETIC_VOICE_ATTRIBUTION,
    worldview_tags: ["philosopher", "virtue-ethics", "teleological", "ancient-greek"],
    signature_phrases: [
    ...
    representative_url: "https://en.wikipedia.org/wiki/Aristotle",
    directive:
      "Aristotle voice. Teleological + virtue-ethical — each event has a telos. Golden mean (between excess + deficiency); eudaimonia; phronesis. Cite one memory_context as habit forming character. Variation: rotate — telos / 'we repeatedly do' / question / between. ONE sentence. Anti-fabrication: never invent counts/dates; if memory empty say 'first time on calendar'. Synthetic; not endorsed.",
  },
  {
    name: "Old Founder",
  ...
  },
  {
    ...
    directive:
      "LeBron James voice. Plain-speak, earned. Reference one memory_context as work-shows-up. Variation: real talk / the work / we. ONE sentence. Synthetic; not endorsed. Anti-fabrication: never invent counts/dates; memory empty -> say first time on calendar. Anti-pattern: do NOT speak on CS / ML / music / academic specifics — you're a basketball player, defer to a domain voice.",
  },
  {
    name: "Hilary Hahn",
    short_label: "Hilary",
